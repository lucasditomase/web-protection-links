...
By using this application, you agree to the following terms of service; I am an independent solo developer with no company team, employees, headquarters, or office, and I am the sole owner of this application, its code, and all related intellectual property.  
...
- ### [1.4](#14-resale-and-redistribution) Resale and Redistribution  
  Resale, redistribution, sublicensing, rental, bundling, or commercial re-offering of this application is not permitted.  
  
- ### [1.5](#15-trademark-and-brand-use) Trademark and Brand Use  
  Unauthorized use of my trademarks, app names, logos, icons, screenshots, branding, or other app assets is strictly prohibited.  
  
## 2. Prohibited Activities  
  
- ### [2.1](#21-reverse-engineering) Reverse Engineering  
  Any attempt to reverse engineer the application or its code is strictly forbidden.  
  
- ### [2.2](#22-unauthorized-modifications) Unauthorized Modifications  
  I do not allow sideloading, tweaks, or jailbreaking of my applications.  
  
- ### [2.3](#23-illegal-use) Illegal Use  
  The application must not be used for any illegal activities.  
  
- ### [2.4](#24-fraud) Fraud  
  Providing falsified information to take advantage of discounts, legacy offers, or promotions is prohibited.  
  
- ### [2.5](#25-abusive-conduct) Abusive Conduct  
  Harassment, abuse, threats, hate speech, abusive messages, and manipulative or abusive App Store review behavior are prohibited.  
  
- ### [2.6](#26-false-or-misleading-statements) False or Misleading Statements  
  Publishing or distributing fake, malicious, or materially inaccurate statements about me or my applications, including deceptive reviews or blog posts, is prohibited.  
  
- ### [2.7](#27-impersonation) Impersonation  
  Any impersonation of me, my brand, or my official communication channels is prohibited.  
...
- ### [3.1](#31-abuse-policy) Abuse Policy  
  I do not tolerate the abuse of refunds, discounts, introductory offers, offer codes, promotions, free trials, or Family Sharing.  
  
- ### [3.2](#32-final-discretion) Final Discretion  
  Any attempt to manipulate the payment or discount system will result in the loss of access to such benefits.  
  
- ### [3.3](#33-apple-subscriptions) Apple Subscriptions  
...
- ### [3.4](#34-apple-billing-and-refund-authority) Apple Billing and Refund Authority  
  Apple handles billing, subscription management, payment-data handling, and refund processing through your App Store account, subject to Apple's policies. I cannot issue refunds directly, do not process card payments, and do not control Apple's billing records. I also do not have access to your full payment or billing identity details, such as full credit or debit card information, billing addresses, or other Apple-held payment credentials. Refund decisions and payment-data handling are controlled by Apple under Apple's policies. I do not accept direct personal payments by any method, and purchases are only available through Apple's App Store purchase systems.  
...
- ### [3.5](#35-business-model-and-monetization-changes) Business Model and Monetization Changes  
  ...
  - ### [3.5.2](#352-purchase-and-offer-configuration-changes) Purchase and Offer Configuration Changes  
    Changes may include adding, removing, or modifying paid features, in-app purchases, subscriptions, lifetime purchases, non-consumable purchases, app pricing, app discounts, free trials, introductory offers, promotional offers, Family Sharing purchase access, and offer or promo codes. Discounts, promo or offer codes, introductory offers, subscription offers, promotional offers, free trials, legacy discount states, legacy promotional states, lifetime purchase availability, Family Sharing eligibility, pricing, and related eligibility terms are temporary and may be introduced, changed, limited, disabled, or removed at any time. Availability, pricing, and eligibility for these options may vary by country, region, platform, storefront rules, or account status.  
...
- ### [7.1](#71-service-changes) Service Changes  
  I reserve the right to modify, suspend, discontinue, replace, or remove the application (or any part thereof) at any time, with or without notice. Older versions of the app may become unavailable on the App Store for download or redownload, including when a newer version is released to replace them. In some cases, updating to the latest available version may be required for security, legal, compatibility, stability, maintenance, or bug-fix reasons. Support for older versions of iOS, iPadOS, macOS, or visionOS, and for older iPhone, iPad, Mac, or Apple Vision Pro device models, may also be dropped at any time for those same reasons.  
...
- ### [8.1](#81-acceptance-of-terms) Acceptance of Terms  
